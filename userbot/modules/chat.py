...
from userbot.utils import edit_delete, edit_or_reply, clown_cmd
from userbot.events import register
from userbot.modules.admin import get_user_from_event
from telethon.utils import pack_bot_file_id


@clown_cmd(pattern="id(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return
...
@clown_cmd(pattern="regexninja (on|off)$")
