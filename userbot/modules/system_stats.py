...
async def bot_ver(event):
    ...
    if which("git") is not None:
        ...
        await event.edit(
            "**⚜-**🤡Clown-Userbot🤡 Versi:** \n "
            f"heads/Clown-Userbot-0-x634i7u1"
            "\n**⚜-**Revisi:**\n "
            f"{revout}"
        )
    else:
...
async def redis(alive):
    ...
    output = (
        ...
        f"  [𝗚𝗿𝗼𝘂𝗽𝘀](https://t.me/ClownSupport) | [𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/ChannelClown) | [𝗚𝗶𝘁𝗵𝘂𝗯](https://github.com/JimmyMahendra/Clown-Userbot) "
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
