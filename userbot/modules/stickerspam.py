...
async def stickerpack_spam(event):
    ...
    try:
        ...
        clown = await edit_or_reply(event, "`Fetching details of the sticker pack, please wait..`"
                                  )
    except BaseException:
        await clown.edit("`This is not a sticker. Reply to a sticker.`", 5)
        return
    try:
        ...
        return await clown.edit("`I guess this sticker is not part of any pack so i cant kang this sticker pack try kang for this sticker`",
                              )
    try:
        hmm = Get(hmm)
